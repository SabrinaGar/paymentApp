export default defineI18nConfig(() => ({
  ...
  messages: {
    es: {
      ...
      app_description:
        "App para gestionar pagos de servicios conectada con API de paises y divisas",
      app_disclaimer:
        "Esta aplicación no se debe utilizar para fines de pago de servicios de manera oficial. Es solo para fines de evaluación de nivel de tecnologías en los procesos de selección de Zexel.",
      payments: "Pagos",
    ...
    "en-us": {
      ...
      app_description:
        "App to manage payments for services connected to countries and currencies API",
      app_disclaimer:
        "This application should not be used for official payment services. It is only for evaluating the level of technologies in the selection processes of Zexel.",
      payments: "Payments",
